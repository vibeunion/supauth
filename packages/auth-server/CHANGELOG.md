...
## [0.8.10](https://github.com/vibeunion/supauth/compare/auth-server-v0.8.9...auth-server-v0.8.10) (2026-09-07)
...
* **auth:** default organization JIT domains ([#52](https://github.com/zuohuadong/supauth/issues/52)) ([11e7b77](https://github.com/zuohuadong/supauth/commit/11e7b778f8594d249ce8fdd5a1bf1e9439f72b2e))
...
## [0.7.0](https://github.com/zuohuadong/supauth/compare/auth-server-v0.6.2...auth-server-v0.7.0) (2026-08-05)
...
* **deploy:** use function scoped runtime env ([94c502c](https://github.com/zuohuadong/supauth/commit/94c502cc32c4b92013eda2049bf56b28b6dbf9f8))

## [0.4.0](https://github.com/zuohuadong/supauth/compare/auth-server-v0.3.0...auth-server-v0.4.0) (2026-07-29)
...
* add gotrue-compatible sso authorize entry ([8f589e9](https://github.com/zuohuadong/supauth/commit/8f589e9ddb31e93c2ffd9553411c751e3edb1072))
...
* **admin:** add refresh-aware SSO requests ([b13be80](https://github.com/zuohuadong/supauth/commit/b13be80394e2b3969f1bacaf3ccc29f3aa72005e))
* **admin:** add refresh-aware SSO requests ([dd10032](https://github.com/zuohuadong/supauth/commit/dd100325c160a5dcd9f55df2cef2b9521112069f))
...
* **auth:** add rotation-safe hosted sessions ([c49f677](https://github.com/zuohuadong/supauth/commit/c49f67714e3a83480237cd0053eb0fddc6bc6f2e))
* **auth:** add rotation-safe hosted sessions ([470b613](https://github.com/zuohuadong/supauth/commit/470b6137248cb44ebc6cb8c8eda7dc3ecdebad05))
...
* **brand:** drive system display name from sign-in-experience.page_title ([a297325](https://github.com/zuohuadong/supauth/commit/a297325133f29c4f31014047455731cc50380103))
* complete P0-25~P0-29 — adapter live contract, project-scoped reconcile, app_metadata merge safety, RBAC bridge, route gate ([b63ccda](https://github.com/zuohuadong/supauth/commit/b63ccda22840c546652887866b15dc76836a82f4))
...
* hosted sign-in page — social login, custom phrases, signup/forgot-password UI, custom UI assets upload ([ab348e8](https://github.com/zuohuadong/supauth/commit/ab348e8cf9c54e13ab81f7ccf61aaaf666479771))
* **hosted-ui:** custom phrases from tenant_configs ([ab348e8](https://github.com/zuohuadong/supauth/commit/ab348e8cf9c54e13ab81f7ccf61aaaf666479771))
* **hosted-ui:** custom UI assets zip upload ([ab348e8](https://github.com/zuohuadong/supauth/commit/ab348e8cf9c54e13ab81f7ccf61aaaf666479771))
* **hosted-ui:** signup and forgot-password forms ([ab348e8](https://github.com/zuohuadong/supauth/commit/ab348e8cf9c54e13ab81f7ccf61aaaf666479771))
* **hosted-ui:** social login buttons from SupaCloud providers ([ab348e8](https://github.com/zuohuadong/supauth/commit/ab348e8cf9c54e13ab81f7ccf61aaaf666479771))
...
* add admin spa route fallback ([4939d9f](https://github.com/zuohuadong/supauth/commit/4939d9f8130ff46a37b92ec4346bc310c517a9e6))
* add admin spa route fallback ([7185859](https://github.com/zuohuadong/supauth/commit/71858598c740dc2b133f111f738eebb28cee96ad))
* address PR review findings ([10b758d](https://github.com/zuohuadong/supauth/commit/10b758df7defdee24f714265081f49c48928931b))
* **admin:** adopt rotation-safe sso sessions ([97c1b0a](https://github.com/zuohuadong/supauth/commit/97c1b0ad8eebfe2bc70a8da5896f1894ea48fef3))
* **auth-server:** export connector provider type ([9b9dd8f](https://github.com/zuohuadong/supauth/commit/9b9dd8f39d9c9e339fc2ea427da45f962bfca47b))
* **auth-server:** export connector provider type ([bff97ce](https://github.com/zuohuadong/supauth/commit/bff97ceeea823c948db28c73b35cf5f8c9440112))
* **auth-server:** harden hosted page path resolution ([1f7c11a](https://github.com/zuohuadong/supauth/commit/1f7c11a8de3344db2c3c5baf33788a42e08b5615))
* **auth-server:** harden sso client lookup ([282d53c](https://github.com/zuohuadong/supauth/commit/282d53c97eb90ec129f5c069d6f3b459857a3146))
* **auth-server:** only show enabled connectors on login page ([4961556](https://github.com/zuohuadong/supauth/commit/4961556b5d74298d9d9997836530dde827af4017))
* **auth-server:** resolve admin-console build path for Bun bundle ([c9bacf9](https://github.com/zuohuadong/supauth/commit/c9bacf90b4bae5a8ad0ac97da5ba1acc1076f93f))
* **auth:** accept case-insensitive bearer schemes ([af86e6b](https://github.com/zuohuadong/supauth/commit/af86e6b61a772fba2d7221a78a940cf09ebb9b0c))
* **auth:** allow registered client-only logout redirects ([2ef2391](https://github.com/zuohuadong/supauth/commit/2ef2391811dfb30c10c9f26362feaec5a934b946))
* **auth:** complete logout session flow ([8853b0c](https://github.com/zuohuadong/supauth/commit/8853b0c3a6bfa6edd1ec65a1be6193ce4606c4d4))
* **auth:** enforce deployable admin sso with strict compat ([95cbe7c](https://github.com/zuohuadong/supauth/commit/95cbe7cd8e474a7c6a4a4f3071e1a0c7535e9e7d))
* **auth:** harden hosted sign-in and account claiming ([27afc22](https://github.com/zuohuadong/supauth/commit/27afc22f4791419a77bc610ff321ec1c1a4df4c8))
* **auth:** harden project-scoped runtime reconciliation ([3a9ba57](https://github.com/zuohuadong/supauth/commit/3a9ba57adc179f055f0b136008d584b1d17774a0))
* **auth:** keep hosted session rotation safe ([4190c7c](https://github.com/zuohuadong/supauth/commit/4190c7c04c7d999aefc52546e8ccb2d974c95ee9))
* **auth:** prefer dedicated OAuth internal runtime URL ([efc9bf4](https://github.com/zuohuadong/supauth/commit/efc9bf450c7ba8fcc5864845e97ce261d5b4c72a))
* **auth:** preserve central idp oauth flow ([4607594](https://github.com/zuohuadong/supauth/commit/46075940595a9c30d2daab78155663ca13db9251))
* **auth:** resolve bundled admin console assets ([daadd1e](https://github.com/zuohuadong/supauth/commit/daadd1e4058ceebf0204e691e6fd37f9a73a02f3))
* **auth:** restore live admin sso oauth project routing ([d7d136f](https://github.com/zuohuadong/supauth/commit/d7d136fa13d12b8097bc00ba5977c44fcfacef20))
* **auth:** serve admin assets with safe media types ([243fc2e](https://github.com/zuohuadong/supauth/commit/243fc2e4298e4d92e5448ab27a047022c83a6976))
* **auth:** serve hosted login at /login ([6893e7b](https://github.com/zuohuadong/supauth/commit/6893e7b911b3a478c254db25eaacbe9e998397d1))
* **auth:** serve hosted oauth page with custom domain API base ([bad20e8](https://github.com/zuohuadong/supauth/commit/bad20e881f452cf9dbf0f2b55032c534355b1dfd))
* **auth:** stabilize account claims and project mapping ([964d3fd](https://github.com/zuohuadong/supauth/commit/964d3fd11b4371d48a23f79687a2bfc4d0073c95))
* **auth:** support standalone hosted login ([9d0b02b](https://github.com/zuohuadong/supauth/commit/9d0b02b20645d3803735a57687b74c1ca232c866))
* **auth:** surface signup runtime drift ([af75a69](https://github.com/zuohuadong/supauth/commit/af75a699d53a1c43b96590d30c3c44783f79b5b4))
* **auth:** surface signup runtime drift ([ec76910](https://github.com/zuohuadong/supauth/commit/ec769104db9fc4e9a76df081f0fa60446dcdf3cf))
* avoid spa fallback for admin assets ([c826e78](https://github.com/zuohuadong/supauth/commit/c826e78c0d25d9f375d26bacb42e5f28537cb4c1))
* avoid spa fallback for admin assets ([cd0075d](https://github.com/zuohuadong/supauth/commit/cd0075d2e9775e5725bf6efe9875f7cb765c8da1))
* **brand:** keep non-stock tenant system name from being overridden by app metadata ([e2d7a66](https://github.com/zuohuadong/supauth/commit/e2d7a66373da277d3389b8f0b2542c0f4d884f6e))
* **deploy:** support latest SupaCloud gateway ([564f914](https://github.com/zuohuadong/supauth/commit/564f914c50ed83d0dd911733e61523fa0393639f))
* **hosted-auth:** block expired authorization pages ([09f001a](https://github.com/zuohuadong/supauth/commit/09f001a678b04b19abf12d19c85ab7bd16454ff1))
* **hosted-auth:** require explicit connector enablement ([4ed8527](https://github.com/zuohuadong/supauth/commit/4ed8527c2ede785fa3b0c06c4461e290a7b0dfa2))
* **hosted-auth:** serve favicon on hosted pages ([671a96d](https://github.com/zuohuadong/supauth/commit/671a96d33e732dffcc4157bcacac6627ce57717b))
...
* **auth-server:** move hosted pages to dedicated route module ([#5](https://github.com/zuohuadong/supauth/issues/5)) ([49bb0df](https://github.com/zuohuadong/supauth/commit/49bb0dfb7032a4db386c4681a46ea931326c4b70))


### Miscellaneous Chores

* release main ([6567d04](https://github.com/zuohuadong/supauth/commit/6567d04d3572a875e373db01794af36e955c8f11))
* release main ([01226b4](https://github.com/zuohuadong/supauth/commit/01226b43a5fbb6710aab4361a5c9c8294015fc2e))
* release main ([01439f5](https://github.com/zuohuadong/supauth/commit/01439f5da1246a155ab9ec91621358b8e2382c60))
* release main ([700367f](https://github.com/zuohuadong/supauth/commit/700367f61c108b45d89692474646d0f89970e3a3))
...
* upgrade Supabase and SupaCloud SDK compatibility ([bc757a7](https://github.com/zuohuadong/supauth/commit/bc757a7f04cdbb1d31df9e89357bd58fe38ee141))


### CI

* publish server and console release artifacts ([3045c7a](https://github.com/zuohuadong/supauth/commit/3045c7a465f375360e67f44f859a3c2445ec8bb7))
