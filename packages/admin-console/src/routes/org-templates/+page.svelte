<script>
  ...
  let form = $state({
    name: '',
    description: '',
    template_roles: '[{"name":"owner","permissions":["organization.manage","resource.read","resource.write"]},{"name":"member","permissions":["resource.read"]}]',
    template_scopes: '[{"name":"resource.read","description":"Read resources"},{"name":"resource.write","description":"Write resources"}]',
    is_default: false,
  });
