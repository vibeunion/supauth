...
Dependency-free TypeScript authorization contracts and in-memory decisions. Authentication remains the identity provider's responsibility; this package resolves one application-and-domain-scoped snapshot per request and never acts as a remote PDP.
